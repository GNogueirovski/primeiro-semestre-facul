...
public class Main {
    public static void main(String[] args) {
        ...
        try{
            nome = JOptionPane.showInputDialog("Digite o nome da pessoa: ").toUpperCase();
            ...
            JOptionPane.showMessageDialog(null, String.format("Dados pessoais \nNome: %s \nData de Nascimento: %s \nIdade: %d ano(s)", pessoa1.getNome(),pessoa1.getDataNascimento().format(dtf), pessoa1.calcularIdade()));
